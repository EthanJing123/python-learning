...
# 案例1: 现有两个变量, 分别为: a = 10, b = 20, 现需要将这俩个变量值进行交换,然后输出到控制台.
# a = 10
# b = 20
#
# # 组包
...
# print(b)
#
# # 案例2: 现有三个变量, 分别为: a = 100, b = 200, c = 300, 现需要将这三个变量进行交换, 将a, b, c 的值分别赋值给c, a, b, 并将其输出到控制台
# a = 100
# b = 200
# c = 300
#
